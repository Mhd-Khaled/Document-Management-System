<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/RequestMasterPage.master" AutoEventWireup="true" CodeFile="RequestUser.aspx.cs" Inherits="Request" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td class="style3" rowspan="3">
                <asp:HiddenField ID="HiddenSend" runat="server" />
            </td>
