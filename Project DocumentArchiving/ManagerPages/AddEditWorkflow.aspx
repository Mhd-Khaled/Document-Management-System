<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ManagerMasterPage.master" AutoEventWireup="true" CodeFile="AddEditWorkflow.aspx.cs" Inherits="ManagerPages_AddEditWorkflow" %>
        ...
        <tr>
            <td class="style1" colspan="2">
                ...
                <asp:GridView ID="WorkflowGridView" runat="server" AutoGenerateColumns="False" 
                    ...
                    DataKeyNames="IdWorkflowDoc" Width="440px">
                    <Columns>
